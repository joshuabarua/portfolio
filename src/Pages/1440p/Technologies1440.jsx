...
function Technologies1440() {
	...
	return (
		<main className="h-screen w-[90%] flex justify-end items-center pr-[5%] mb-[5%]">
			<div className=" w-[55%] overflow-y-auto flex gap-10 flex-col">
				<h1 className="text-4xl text-left dark-text dark:light-text leading-tight font-bold mt-[150px]">Technologies</h1>
				<section>
					<h4 className="text-md dark-text dark:light-text lg:text-lg xl:text-2xl xl:leading-tight font-bold pt-5 opacity-70">Frequently Used</h4>
					<section className="tech-large flex flex-wrap items-center gap-5 pt-2 pb-6">
				...
				<section>
					<h4 className="text-md dark-text dark:light-text lg:text-lg xl:text-2xl xl:leading-tight font-bold opacity-70">Familiar With</h4>
					<section className="tech-large flex flex-wrap items-center gap-5 pt-2 pb-6">
				...
				<section>
					<h4 className="text-md dark-text dark:light-text lg:text-lg xl:text-2xl xl:leading-tight font-bold opacity-70">Tools</h4>
					<section className="tech-large flex flex-wrap items-center gap-5 pt-2 mb-[50px]">
...
export default Technologies1440;
