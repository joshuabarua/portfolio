...
function TechMobile() {
	...
	return (
		<main className="h-screen w-full flex justify-center items-center flex-col overflow-y-auto h-md:mb-[10%]">
			...
			<div className=" w-[70%] overflow-x-hidden pb-10">
				<section className="">
					...
					<section className="tech flex flex-wrap items-center gap-5 pt-2 pb-6 rounded-xl  p-2 overflow-x-hidden">
				...
				<section>
					...
					<section className="tech flex flex-wrap items-center gap-5 pt-2 mb-[50px rounded-xl   p-2 overflow-x-hidden">
