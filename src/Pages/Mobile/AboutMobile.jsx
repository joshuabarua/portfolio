...
function AboutMobile() {
	...
	return (
		<>
			...
			<div className="w-full flex items-end flex-col-reverse mb-[10%] overflow-hidden">
				<div className="flex items-end flex-col-reverse w-5/6 overflow-hidden">
					<p className="wrapped-text text-dark-text backdrop-opacity-30 backdrop-blur-xl dark:text-light-text text-sm leading-tight sm:text-lg pb-6 pr-6">{about}</p>
				</div>
			</div>
		</>
	);
