  ...
  return (
    <main className="flex h-screen w-[100%] flex-col items-end justify-center ">
      <section className=" mb-[10%] flex w-[80%] flex-col items-center justify-center">
        <h1 className="dark-text dark:light-text text-3xl font-bold xl:leading-tight">
          Contact
        </h1>
        <form
        ...
        >
          ...
          <label
            htmlFor="email-name"
            className="dark-text  dark:light-text block text-lg font-medium"
          >
            Name
          </label>
          ...
          <div>
            <label
              htmlFor="message"
              className="dark-text dark:light-text mb-2 block text-lg font-medium"
            >
              Message
            </label>
            <textarea
          ...
          <button
            type="submit"
            className="h-[40px] w-[100%] rounded-md bg-slate-200 p-3 dark:bg-slate-700"
          >
            Send
          </button>
        </form>
