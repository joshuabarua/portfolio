...
function Work({position, description, company, location, type, duration, website, tech}) {
	return (
		<article className=" border-b-2 mb-12  border-dark-content dark:border-light-content border-opacity-20 dark:border-opacity-60  pr-[25px]">
			...
			<div className="flex flex-col justify-between items-left py-2 gap-1 sm:flex-row">
				<div className="flex items-center">
					<svg className="dark:fill-light-heading fill-dark-heading min-w-fit" width="26" height="26" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<p className="wrapped-text text-xs md:text-sm font-light pl-1 opacity-80">
				...
				<div className="flex items-center">
					...
					<p className="wrapped-text  text-xs md:text-sm font-light pl-1 opacity-80">{location}</p>
				</div>
				<p className="wrapped-text text-xs md:text-sm font-light pl-1 min-w-fit opacity-80">{duration}</p>
			</div>
			<div className="">
				<h3 className="wrapped-text text-sm leading-6 md:text-md lg:text-lg font-light pb-4 opacity-70">{description}</h3>
			</div>
