			...
			<div className="flex flex-col gap-2">
				...
				<div className="flex flex-col justify-between items-left py-2 gap-1 sm:flex-row">
					<div className="flex items-center">
						...
						<p className="wrapped-text text-sm md:text-md lg:text-lg xl:text-xl font-light pl-1 opacity-80">
					...
					<div className="flex items-center">
						...
						<p className="wrapped-text text-sm md:text-md lg:text-lg xl:text-xlfont-light pl-1 opacity-80">{location}</p>
					</div>
				</div>
				<div className="flex flex-col justify-between items-left py-2 gap-1 sm:flex-row">
				...
				<div className="workImg flex flex-wrap justify-around items-baseline w-full gap-4 pb-2">
					{tech ? (
						tech.map((item, idx) => {
							return <img src={item} className="w-[30px] lg:w-[50px] " alt="" key={idx} />;
						})
					) : (
						<></>
					)}
